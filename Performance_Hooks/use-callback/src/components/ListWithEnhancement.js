...
export default function ListWithEnhancement() {
  ...
  return (
    <Fragment>
      <button onClick={() => setIsBought(!isBought)}>
        Change State directly
      </button>
      <Display items={items} updateState={updateState} />
    </Fragment>
  );
}

const Display = memo(function Display({ items, updateState }) {
  console.log("sdf");
  return (
    <Fragment>
